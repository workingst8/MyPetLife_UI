...
const Chat: React.FC = () => {
  const [messages, setMessages] = useState<
    { content: string; time: string; fromMe: boolean }[]
  >([]);
      ...
      <div className={styles.wrap}>
        ...
        <div className={styles.middle}>
          ...
          {messages.map((message, index) => (
            <div
              key={index}
              className={message.fromMe ? styles.me : styles.other}
            >
              {!message.fromMe && (
                <img src="./images/chat/default_other.svg" alt="other" />
              )}
              {message.fromMe && (
              ...
              {message.fromMe && (
                <img src="./images/chat/default_me.svg" alt="me" />
              )}
              {!message.fromMe && (
                <span className={styles.time}>{message.time}</span>
              )}
